    ...
    >
      ...
      >
        <Field
          label={
            <React.Fragment>
              Department token name
              <Help hint="What is Department Token Name?">
                <strong>Department Token Name</strong> will be the name
                assigned to the token representing the Department.{' '}
                <em>For example: My Department Token.</em>
              </Help>
            </React.Fragment>
          }
        >
          {({ id }) => (
            <TextInput
              ...
              placeholder="My Department Token"
              value={tokenName}
              wide
            />
          )}
        ...
        <Field
          label={
            <React.Fragment>
              Department token symbol
              <Help hint="What is Department Token Symbol?">
                <strong>Department Token Symbol</strong> will be the shortened
                name (typically in capital letters) assigned to the
                Department's token. <em>For example: DPT.</em>
              </Help>
            </React.Fragment>
          }
        >
...
Department.formatReviewFields = formatReviewFields
